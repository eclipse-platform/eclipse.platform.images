...
The "UI Graphics" chapter of the [Eclipse User Interface Guidelines](https://wiki.eclipse.org/User_Interface_Best_Practices_Working_Group) gives some advice about the stylistic as well as the implementation aspects of graphics used in eclipse based tools.
